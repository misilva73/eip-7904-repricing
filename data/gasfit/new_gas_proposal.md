...
_Generated 2026-06-08 07:31:48Z · fork `osaka` · anchor_rate 100 Mgas/s_

**Summary:** 18 parameters proposed — 1 increased, 16 decreased, 0 new, 0 unresolved · 0 warnings · 1 poor-fit selection
...
| PRECOMPILE_ECRECOVER | 3000 | 833 | -2167 | -72% |
| PRECOMPILE_BLAKE2F_BASE | 0 | 94 | +94 | n/a |
| PRECOMPILE_BLAKE2F_PER_ROUND | 1 | 1 | 0 | 0% |
| PRECOMPILE_BLS_G1ADD | 375 | 174 | -201 | -54% |
| PRECOMPILE_BLS_G2ADD | 600 | 212 | -388 | -65% |
| PRECOMPILE_ECADD | 150 | 108 | -42 | -28% |
| PRECOMPILE_ECPAIRING_BASE | 45000 | 8247 | -36753 | -82% |
| PRECOMPILE_ECPAIRING_PER_POINT | 34000 | 11695 | -22305 | -66% |
| PRECOMPILE_POINT_EVALUATION | 50000 | 23342 | -26658 | -53% |
| PRECOMPILE_P256VERIFY | 6900 | 1420 | -5480 | -79% |
...
| --- | --- | --- | --- | --- | --- |
| OPCODE_DIV | besu | 2 | erigon | 1 | 2.00× |
...
| PRECOMPILE_ECRECOVER | erigon | 833 | geth | 781 | 1.07× |
| PRECOMPILE_BLAKE2F_BASE | erigon | 94 | besu | 41 | 2.29× |
| PRECOMPILE_BLAKE2F_PER_ROUND | besu | 1 | erigon | 1 | 1.00× |
| PRECOMPILE_BLS_G1ADD | besu | 174 | erigon | 100 | 1.74× |
| PRECOMPILE_BLS_G2ADD | besu | 212 | nethermind | 149 | 1.42× |
| PRECOMPILE_ECADD | erigon | 108 | reth | 96 | 1.12× |
| PRECOMPILE_ECPAIRING_BASE | reth | 8247 | nethermind | 6663 | 1.24× |
| PRECOMPILE_ECPAIRING_PER_POINT | nethermind | 11695 | reth | 6080 | 1.92× |
| PRECOMPILE_POINT_EVALUATION | nethermind | 23342 | besu | 20864 | 1.12× |
| PRECOMPILE_P256VERIFY | erigon | 1420 | geth | 1180 | 1.20× |
...
| `JUMPI` | `besu` (R²) | `PRECOMPILE_BLAKE2F_BASE`, `PRECOMPILE_ECADD`, `PRECOMPILE_ECPAIRING_BASE`, `PRECOMPILE_P256VERIFY`, `PRECOMPILE_POINT_EVALUATION` |
